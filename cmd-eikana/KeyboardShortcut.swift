...
class KeyboardShortcut: NSObject {
  ...
  func isCommandDown() -> Bool {
    return self.flags.rawValue & CGEventFlags.maskCommand.rawValue != 0 && keyCode != 54
      && keyCode != 55
  }

  func isShiftDown() -> Bool {
    return self.flags.rawValue & CGEventFlags.maskShift.rawValue != 0 && keyCode != 56
      && keyCode != 60
  }

  func isControlDown() -> Bool {
    return self.flags.rawValue & CGEventFlags.maskControl.rawValue != 0 && keyCode != 59
      && keyCode != 62
  }

  func isAlternateDown() -> Bool {
    return self.flags.rawValue & CGEventFlags.maskAlternate.rawValue != 0 && keyCode != 58
      && keyCode != 61
  }
